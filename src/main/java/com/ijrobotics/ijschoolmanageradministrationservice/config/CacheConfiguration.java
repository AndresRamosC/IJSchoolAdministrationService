...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("IJSchoolManagerAdministrationService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("IJSchoolManagerAdministrationService");
        ...
        config.getMapConfigs().put("com.ijrobotics.ijschoolmanageradministrationservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
