...
/**
 * REST controller for managing {@link com.ijrobotics.ijschoolmanageradministrationservice.domain.ClassSchedule}.
 */
@RestController
@RequestMapping("/api")
public class ClassScheduleResource {
    ...
    private static final String ENTITY_NAME = "ijSchoolManagerAdministrationServiceClassSchedule";
    ...
    public ResponseEntity<ClassScheduleDTO> createClassSchedule(@RequestBody ClassScheduleDTO classScheduleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ClassScheduleDTO> updateClassSchedule(@RequestBody ClassScheduleDTO classScheduleDTO) throws URISyntaxException {
