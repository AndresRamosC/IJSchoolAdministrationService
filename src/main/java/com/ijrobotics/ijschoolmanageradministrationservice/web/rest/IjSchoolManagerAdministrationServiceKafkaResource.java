...
@RestController
@RequestMapping("/api/ij-school-manager-administration-service-kafka")
public class IjSchoolManagerAdministrationServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IjSchoolManagerAdministrationServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IjSchoolManagerAdministrationServiceKafkaResource(KafkaProperties kafkaProperties) {
