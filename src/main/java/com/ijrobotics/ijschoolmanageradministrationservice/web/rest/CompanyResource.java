...
import com.ijrobotics.ijschoolmanageradministrationservice.service.CompanyService;
...
/**
 * REST controller for managing {@link com.ijrobotics.ijschoolmanageradministrationservice.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "ijSchoolManagerAdministrationServiceCompany";
    ...
    public ResponseEntity<CompanyDTO> createCompany(@RequestBody CompanyDTO companyDTO) throws URISyntaxException {
        ...
        companyDTO.setCreationDate(ZonedDateTime.now());
