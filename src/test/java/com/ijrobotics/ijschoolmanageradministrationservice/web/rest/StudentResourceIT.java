...
public class StudentResourceIT {
    ...
    private static final LocalDate DEFAULT_ADMISSIN_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_ADMISSIN_DATE = LocalDate.now(ZoneId.systemDefault());
