...
import com.ijrobotics.ijschoolmanageradministrationservice.config.KafkaProperties;
...
class IjSchoolManagerAdministrationServiceKafkaResourceIT {
    ...
    void setup() {
        ...
        IjSchoolManagerAdministrationServiceKafkaResource kafkaResource = new IjSchoolManagerAdministrationServiceKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/ij-school-manager-administration-service-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/ij-school-manager-administration-service-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
